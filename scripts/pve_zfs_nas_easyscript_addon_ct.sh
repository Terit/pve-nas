...
cat <<-EOF > input_list
Addon|Jailed User Account|a Home folder jailed user (chroot user)|https://raw.githubusercontent.com/Terit/pve-nas/master/scripts/pve_zfs_nas_add_jailuser_ct.sh
Addon|Power User Account|member of medialab, homelab or privatelab|https://raw.githubusercontent.com/Terit/pve-nas/master/scripts/pve_zfs_nas_add_poweruser_ct.sh
Addon|Kodi Rsync User Account|special user for Kodi player data rsync|https://raw.githubusercontent.com/Terit/pve-nas/master/scripts/pve_nfs_nas_add_rsyncuser_ct.sh
Addon|SSMTP Server| email server for sending PVE email alerts|https://raw.githubusercontent.com/Terit/pve-nas/master/scripts/pve_zfs_nas_install_ssmtp_ct.sh
Addon|ProFTPd Server|a sFTP server for Power & Jailed user accounts|https://raw.githubusercontent.com/Terit/pve-nas/master/scripts/pve_zfs_nas_install_proftpd_ct.sh
Addon|PVE NAS OS Version Release Updater|backup critical data first|https://raw.githubusercontent.com/Terit/pve-nas/master/scripts/pve_zfs_nas_version_updater_ct.sh
